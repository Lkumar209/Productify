...
# textbox1=Entry(frame1, textvariable=email, font=('Arial',14))
# textbox1.grid(row=0, column=1)

# label2 = Label(frame1, text='Enter your phone #: ', font=('Arial',14))
# label2.grid(row=2, column=0, padx=5, pady=10)

# textbox2=Entry(frame1, textvariable=phonenumber, font=('Arial',14))
...
frame5=Frame(window, height = 350, width = 400, highlightbackground='black',highlightthickness = 5)
